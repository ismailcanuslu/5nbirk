            ...
            <Container fluid className="d-flex p-0">
                ...
                >
                    ...
                    <Nav.Item>
                        ...
                        {!collapsed && openPosts && (
                            <Nav className="flex-column ms-4">
                                ...
                                <Nav.Link as={Link} to="/admin/posts/create" style={{ color: '#6c757d' }}>Yeni Yazı Ekle
                                </Nav.Link>
                                <Nav.Link as={Link} to="/admin/posts/categories" style={{ color: '#6c757d' }}>Kategoriler
                                </Nav.Link>
                                <Nav.Link as={Link} to="/admin/posts/authors" style={{ color: '#6c757d' }}>Yazarlar
                                </Nav.Link>
                    ...
                    <Nav.Item>
                        ...
                        {!collapsed && openMedia && (
                            <Nav className="flex-column ms-4">
                                <Nav.Link as={Link} to="/admin/files" style={{ color: '#6c757d' }}>Kütüphane</Nav.Link>
                                <Nav.Link as={Link} to="/admin/files/upload" style={{ color: '#6c757d' }}>Yeni Ortam Ekle</Nav.Link>
                            </Nav>
                        )}
                    </Nav.Item>
